...
<div class="box1 clear">
	...
	<form action="teacher_manage_notify_add" class="exam-form" enctype="multipart/form-data" method="post" style="padding:20px;background-color:#EEE;margin:0 0 20px">
	 <h3>新增通知信息</h3>
	 <input name="notice" placeholder="通知消息内容"  type="text">
	...
	<table class="table" border="1" style="width:100%;padding:20px;">
		 ...
		 <tboby>
		  <tr>
		   <td>xxxx</td>
		   <td>
		    <a href="teacher_manage_notify_del?nid=0">
		    删除
		    </a>
		    </td>
		    </tr>
