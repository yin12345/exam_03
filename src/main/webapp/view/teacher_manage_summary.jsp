	...
	<div class="layui-row layui-col-space15">
		...
		<div class="layui-col-md6" style="width: 100%;">
			<div class="layui-card" >
				<div class="layui-card-header"><strong style="font-size:20px">考试情况</strong></div>
				<div class="layui-card-body">


					<div style="padding:10px;background-color:#555;color:#FFF;border-radius:6px;font-size:14px;margin:0 0 10px">
						<h3>${sessionScope.exam.ename} 进行情况：</h3>
						<p>参加考试学生总数： ${sessionScope.studentNum}</p>
						<p>已登陆学生数量：${sessionScope.online}，未登录学生数量：${sessionScope.unline}</p>
						<p>已登陆学生中，提交文件学生数量：${sessionScope.submit}，未提交文件学生数量：${sessionScope.unsubmit}</p>
					</div>
